...
def backup_mellanox(ip_address):
    # Подключение к коммутатору Mellanox
    mellanox_device = {
        'host': ip_address,
        'username': 'admin',
        'password': 'admin',
        'device_type': 'mellanox'  # 'mellanox_sx'
    }

    with netmiko.ConnectHandler(**mellanox_device) as net_conn:
